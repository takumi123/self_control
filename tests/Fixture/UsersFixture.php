...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'display_cycle_time' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => 'é€±', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'activate' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'type' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'display_cycle_time' => 'Lorem ipsum dolor sit amet',
                'activate' => 1,
                'type' => 1,
                'created' => '2018-05-24 14:19:58',
                'modified' => '2018-05-24 14:19:58'
            ],
        ];
        parent::init();
    }
